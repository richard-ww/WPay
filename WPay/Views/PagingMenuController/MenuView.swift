...
open class MenuView: UIScrollView {
    ...
    lazy fileprivate var seperatorView = UIView()
    ...
    fileprivate func layoutScrollView() {
        ...
        //TODO: HaiLong 这里为了适配66的设计, 对源码做了修改
        seperatorView.backgroundColor   = UIColor(white: 227/255, alpha: 1)
        seperatorView.frame             = CGRect(x: 15, y: self.bounds.height-0.5, width: UIScreen.main.bounds.width-30, height: 0.5)
    }
    ...
    fileprivate func animateUnderlineViewIfNeeded() {
        ...
        underlineView.frame.origin.x = targetFrame.minX + horizontalPadding+15
        underlineView.frame.size.width = targetFrame.width - horizontalPadding * 2-30
    }
